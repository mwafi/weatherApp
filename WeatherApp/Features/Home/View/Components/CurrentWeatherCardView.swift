    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text(dateText)
                ...
                .padding(.top, 24)
                .accessibilityIdentifier("currentWeatherDateText")
            ...
            Text(temperatureText)
                ...
                .padding(.top, 10)
                .accessibilityIdentifier("currentWeatherTemperatureText")
            ...
            Text(conditionText)
                ...
                .padding(.top, 8)
                .accessibilityIdentifier("currentWeatherConditionText")
            ...
            VStack(spacing: 16) {
                ...
                HStack(spacing: 0) {
                    Image("windy")
                        ...
                        .accessibilityIdentifier("windIcon")
                    ...
                    Text("Wind")
                        ...
                        .accessibilityIdentifier("windLabelText")

                    Text("|")
                        .font(.custom("Overpass-Light", size: 17))
                        .foregroundColor(.white.opacity(0.7))
                        .frame(width: 18)
                        .accessibilityIdentifier("windSeparatorText")
                    ...
                    Text(windText)
                        ...
                        .accessibilityIdentifier("currentWeatherWindValueText")
                }
                .accessibilityIdentifier("windInfoRow")
                ...
                HStack(spacing: 0) {
                    Image("hum")
                        ...
                        .scaledToFit()
                        .frame(width: 18, height: 18)
                        .accessibilityIdentifier("humidityIcon")
                    ...
                    Text("Hum")
                        ...
                        .shadow(color: .black.opacity(0.15), radius: 2, x: 1, y: 2)
                        .frame(width: 42, alignment: .leading)
                        .accessibilityIdentifier("humidityLabelText")

                    Text("|")
                        .font(.custom("Overpass-Light", size: 17))
                        .foregroundColor(.white.opacity(0.7))
                        .frame(width: 18)
                        .accessibilityIdentifier("humiditySeparatorText")
                    ...
                    Text(humidityText)
                        ...
                        .shadow(color: .black.opacity(0.15), radius: 2, x: 1, y: 2)
                        .frame(width: 78, alignment: .leading)
                        .accessibilityIdentifier("currentWeatherHumidityValueText")
                }
                .accessibilityIdentifier("humidityInfoRow")
            }
            .frame(width: 170)
            .padding(.top, 28)
            .accessibilityIdentifier("weatherMetricsContainer")
