...
struct HomeBackgroundView: View {
    var body: some View {
        ZStack {
            ...
            .accessibilityIdentifier("homeBackgroundGradient")
            ...
            Image("Vector 12")
                ...
                .offset(x: -25, y: 92)
                .contrast(1.5)
                .accessibilityIdentifier("homeBackgroundVectorLeft")
            ...
            Image("Vector 11")
                ...
                .offset(x: 59, y: -54)
                .contrast(1.5)
                .accessibilityIdentifier("homeBackgroundVectorTop")
        }
        .ignoresSafeArea()
        .accessibilityIdentifier("homeBackgroundView")
    }
}
